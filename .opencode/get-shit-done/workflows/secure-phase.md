...
```
Agent(
  prompt="Read /Users/tcotd/seb-lab/instagram-advisor/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tcotd/seb-lab/instagram-advisor/.opencode/get-shit-done/templates/SECURITY.md`
