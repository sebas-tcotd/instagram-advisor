...
```bash
INIT=$(node "/Users/tcotd/seb-lab/instagram-advisor/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/tcotd/seb-lab/instagram-advisor/.opencode/get-shit-done/templates/spec.md.
