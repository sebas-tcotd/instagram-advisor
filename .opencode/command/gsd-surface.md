...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/tcotd/seb-lab/instagram-advisor/.opencode/.gsd-surface.json`
(sibling to `/Users/tcotd/seb-lab/instagram-advisor/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/tcotd/seb-lab/instagram-advisor/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/tcotd/seb-lab/instagram-advisor/.opencode/skills`).
...
`/Users/tcotd/seb-lab/instagram-advisor/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/tcotd/seb-lab/instagram-advisor/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/tcotd/seb-lab/instagram-advisor/.opencode/.gsd-surface.json`
Install profile marker: `/Users/tcotd/seb-lab/instagram-advisor/.opencode/.gsd-profile`
Skill dirs: `/Users/tcotd/seb-lab/instagram-advisor/.opencode/skills/gsd-*/`
Engine module: `/Users/tcotd/seb-lab/instagram-advisor/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/tcotd/seb-lab/instagram-advisor/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
