...
- **Global scope**: `/Users/tcotd/seb-lab/instagram-advisor/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tcotd/seb-lab/instagram-advisor/.claude/notes/`)
...
2. Glob `/Users/tcotd/seb-lab/instagram-advisor/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tcotd/seb-lab/instagram-advisor/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tcotd/seb-lab/instagram-advisor/.claude/notes/` — works in any directory
