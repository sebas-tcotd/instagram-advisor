...
INSTALL_JS_GLOBAL="/Users/tcotd/seb-lab/instagram-advisor/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/tcotd/seb-lab/instagram-advisor/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
