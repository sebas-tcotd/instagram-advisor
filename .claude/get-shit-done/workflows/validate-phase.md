...
```
Agent(
  prompt="Read /Users/tcotd/seb-lab/instagram-advisor/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tcotd/seb-lab/instagram-advisor/.claude/get-shit-done/templates/VALIDATION.md`
