...
describe('GeminiProvider', () => {
  ...
  describe('auditProfile', () => {
    ...
    it('returns AuditResult with parsed overallScore when Gemini returns valid JSON', async () => {
      fetchSpy.mockResolvedValue(makeGeminiResponse(JSON.stringify(validAuditResult)));
    ...
    it('throws error containing "missing required AuditResult fields" when status/checklist missing', async () => {
      ...
      fetchSpy.mockResolvedValue(makeGeminiResponse(JSON.stringify(invalid)));
    ...
    it('throws error containing "checklist item missing required fields" when priority is invalid', async () => {
      ...
      fetchSpy.mockResolvedValue(makeGeminiResponse(JSON.stringify(invalidPriority)));
    ...
    it('throws error containing "Cannot parse overallScore" when overall is unparseable', async () => {
      ...
      fetchSpy.mockResolvedValue(makeGeminiResponse(JSON.stringify(unparseable)));
