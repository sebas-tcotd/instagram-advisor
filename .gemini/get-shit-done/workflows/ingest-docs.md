...
```bash
INIT=$(node "/Users/tcotd/seb-lab/instagram-advisor/.gemini/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/tcotd/seb-lab/instagram-advisor/.gemini/get-shit-done/bin/gsd-tools.cjs" commit \
