...
```
Agent(
  prompt="Read /Users/tcotd/seb-lab/instagram-advisor/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tcotd/seb-lab/instagram-advisor/.gemini/get-shit-done/templates/VALIDATION.md`
