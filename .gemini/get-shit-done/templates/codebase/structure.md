...
- Usage: Reference from command with `@/Users/tcotd/seb-lab/instagram-advisor/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/tcotd/seb-lab/instagram-advisor/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/tcotd/seb-lab/instagram-advisor/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
